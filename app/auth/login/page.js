  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen relative overflow-hidden bg-gradient-to-r from-emerald-100 to-teal-50">
      ...
      <div className="flex flex-col items-center justify-center mb-8 relative z-10">
        ...
        <span className="text-4xl font-bold text-center text-emerald-800">AgroScan</span>
      </div>
      <div className="w-full max-w-md p-8 space-y-6 rounded-xl bg-white shadow-2xl relative z-10">
        <h2 className="text-2xl font-bold text-center text-emerald-800 mb-6">Welcome Back</h2>
        <p className="text-center text-muted-foreground mb-6">
          Sign in to access your dashboard and continue your farming journey
        </p>
        {error && (
        ...
        <Button 
          ...
          disabled={isLoading}
          className="w-full bg-white hover:bg-gray-50 text-gray-700 border border-gray-300 py-3 rounded-lg transition duration-200 transform hover:scale-105 flex items-center justify-center gap-3"
        >
